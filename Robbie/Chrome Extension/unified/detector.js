...
(function () {
  ...
  // A stronger, comparison-grade company key used by the duplicate-application
  // check. Lower-cases, expands "&"→"and", drops punctuation, and strips common
  // trailing legal suffixes so "Acme, Inc." and "Acme" collapse to one key.
  // Deliberately EXACT (not fuzzy): "meta" and "metabase" stay distinct.
  ...
  window.JobInfo = { extract, normCompany };
})();
